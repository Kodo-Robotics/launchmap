...
from parser.parser.xml.loader import register_builtin_xml_handlers
from parser.parser.xml.registry import get_handler

register_builtin_xml_handlers()
...
def dispatch_element(el: ET.Element, context: ParseContext) -> dict:
    ...
    - Use the raw tag name ('node', 'include', 'group')
